...
# DESCRIPTION
#
#   Test for ProgramOptions library from the Boost C++ libraries. The macro requires
...
[
	...
	AS_HELP_STRING([--with-boost-program-options@<:@=special-lib@:>@],
                   [use the ProgramOptions library from boost - it is possible to specify a certain library for the linker
                        e.g. --with-boost-program-options=boost_program_options-gcc-mt-d-1_33_1 ]),
        [
